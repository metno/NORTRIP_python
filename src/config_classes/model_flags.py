...
class model_flags:
    ...
    use_salting_data_1_flag: float = 1.0
    use_salting_data_2_flag: float = 1.0
    use_sanding_data_flag: float = 0.0
    use_ploughing_data_flag: float = 0.0
    use_cleaning_data_flag: float = 0.0
    use_wetting_data_flag: float = 0.0
