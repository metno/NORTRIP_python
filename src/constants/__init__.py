...
__all__ = [
    ...
    "num_source",
    "num_source_all",
    "num_source_all_extra",
    "dust_index",
    "dust_noexhaust_index",
    "wear_index",
    "all_source_index",
    "all_source_noexhaust_index",
    # Strings defining the plot and save averaging output types
    "av_str",
    # Date data indexing
    "year_index",
    ...
    "short_rad_in_index",
    "long_rad_in_index",
    "short_rad_in_clearsky_index",
    "cloud_cover_index",
    "road_temperature_obs_input_index",
    "road_wetness_obs_input_index",
    "pressure_index",
    "T_dewpoint_index",
    "T_sub_input_index",
    "num_meteo_index",
    ...
    "S_dustspray_index",
    "P_dustspray_index",
    "S_dustdrainage_index",
    "S_suspension_index",
    "S_windblown_index",
    "S_cleaning_index",
    "P_cleaning_index",
    "S_dustploughing_index",
    "P_crushing_index",
    "S_crushing_index",
    "P_abrasion_index",
    "P_depo_index",
    # Salt solution indexes
    "RH_salt_index",
    "melt_temperature_salt_index",
    "dissolved_ratio_index",
    # Dust process emission indexes
    "E_direct_index",
    "E_suspension_index",
    "E_windblown_index",
    ...
    "long_rad_out_index",
    "H_traffic_index",
    "road_temperature_obs_index",
    "road_wetness_obs_index",
    "T_sub_index",
    "short_rad_net_clearsky_index",
    "T_s_dewpoint_index",
    "E_index",
    "E_correction_index",
    # Road moisture mass balance production and sink data
